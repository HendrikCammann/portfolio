      ...
      <div class="container s-is-fullheight margin__top--100">
        <div class="columns s-is-fullheight is-multiline">
          <div class="column is-12">
            ...
            <p>
              Hendrik Cammann <br />
              mail@hendrikcammann.de
            </p>
          </div>
          <div class="column is-12 margin__top--30">
            <h5 class="title font__secondary is-5">Contact<span class="o-background__dot">.</span></h5>
            <p>
              Hendrik Cammann <br />
              Alpenstrasse 10a <br />
              86159 Augsburg
          ...
          <div class="column is-12 margin__top--30">
            <h5 class="title font__secondary is-5">Liability for content<span class="o-background__dot">.</span></h5>
            <p>
          ...
          <div class="column is-12 margin__top--30">
            <h5 class="title font__secondary is-5">Liability for links<span class="o-background__dot">.</span></h5>
            <p>
          ...
          <div class="column is-12 margin__top--30">
            <h5 class="title font__secondary is-5">Copyright<span class="o-background__dot">.</span></h5>
            <p>
          ...
          <div class="column is-12 margin__top--30 margin__bottom--30">
            <h5 class="title font__secondary is-5">Privacy<span class="o-background__dot">.</span></h5>
            <p>
